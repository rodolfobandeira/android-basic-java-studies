    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repository.buscaProdutos(new ProdutoRepository.DadosCarregadosCallback<List<Produto>>() {
            ...
            public void quandoFalha(String erro) {
                Toast.makeText(ListaProdutosActivity.this, "Erro ao tentar buscar produtos da API", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        adapter.setOnItemClickRemoveContextMenuListener(
                (posicao, produtoEscolhido) -> {
                    repository.remove(produtoEscolhido, new ProdutoRepository.DadosCarregadosCallback<Void>() {
                        @Override
                        public void quandoSucesso(Void sucesso) {
    ...
    private void abreFormularioSalvaProduto() {
        new SalvaProdutoDialog(
                ...
                produtoCriado -> repository.salva(produtoCriado, new ProdutoRepository.DadosCarregadosCallback<Produto>() {
                    @Override
                    public void quandoSucesso(Produto sucesso) {
